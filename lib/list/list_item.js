  ...
  _createClass(ListItem, [{
    ...
    value: function render() {
      ...
      if (this.props.autoGenerate) {
        (function () {
          var properties = _this4.props.properties;
          ...
          children = Object.keys(properties).map(function (key) {
            return _react2['default'].createElement(_property2['default'], {
              ...
              validation: _this4.buildValidation(properties[key].validation),
              errorMessage: properties[key].errorMessage,
              inputType: properties[key].type,
              onBlur: _this4.onBlur,
              onChange: _this4.onChange,
              containerClass: properties[key].containerClass || _this4.props.containerClass,
              inputClass: properties[key].inputClass || _this4.props.inputClass,
