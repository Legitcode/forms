...
var SelectInput = (function (_React$Component) {
  ...
  _createClass(SelectInput, [{
    ...
    value: function changeSelected(event) {
      ...
      var selectedDisplay = valueElement.querySelector('.option').innerHTML;
    ...
    value: function render() {
      ...
      var inputClass = 'select ' + this.props.classes;

      return _react2['default'].createElement(
        'div',
        { className: inputClass },
        _react2['default'].createElement('span', { className: 'arrow', ref: 'arrow' }),
        _react2['default'].createElement('input', { name: this.props.name, type: 'hidden', ref: 'valueInput', value: this.props.selected }),
        input,
        _react2['default'].createElement(
          'div',
