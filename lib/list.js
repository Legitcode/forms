...
var List = (function (_React$Component) {
  ...
  _createClass(List, [{
    ...
    value: function componentDidUpdate(prevProps, prevState) {
      if (this.props.listItems) {
        var items = _utilsObj2['default'].clone(_underscore2['default'].compact(this.props.listItems));
    ...
    value: function createChild() {
      ...
      newObject = _utilsObj2['default'].clone(this.props.formAttrs);

      Object.keys(newObject).forEach(function (key) {
        newObject['' + key + '-' + _this5.childCount] = newObject[key];
    ...
    value: function removeChild(ev, listItem) {
      var itemNumber = parseInt(listItem.split('-')[1]);

      var object = _underscore2['default'].find(this.props.listItems, function (item) {
        var itemIndex = parseInt(Object.keys(item)[0].split('-')[1]);
        return itemIndex == parseInt(listItem.split('-')[1]);
      });

      var itemIndex = this.props.listItems.indexOf(object);
