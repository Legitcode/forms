...
var AutoSchema = (function (_React$Component) {
  ...
  function AutoSchema() {
    ...
    this.onChange = function (ev, attrs) {
      _this.props.formActions.updateFormValue(attrs);
      _this.props.onChange(ev, attrs);
    };
    ...
    this.generate = function () {
      ...
      var formAttrs = attributes.formAttrs;
      var containerClass = attributes.containerClass;
      var inputClass = attributes.inputClass;
      ...
      return _underscore2['default'].map(formAttrs, function (value, key) {
        if (!key.match(/list/i)) {
          ...
          return _react2['default'].createElement(_auto_list2['default'], _extends({}, value, {
            ...
            containerClass: value.containerClass || containerClass,
            inputClass: value.inputClass || inputClass,
            addButton: _this.props.addButton,
            removeButton: _this.props.removeButton,
            onChange: _this.onChange,
            onBlur: _this.onBlur,
            addChildToList: _this.props.formActions.addChildToList
          }));
        }
      });
    };
  ...
  _createClass(AutoSchema, [{
    ...
    key: 'propTypes',
    value: {
      formActions: _react2['default'].PropTypes.object,
